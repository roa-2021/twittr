...
const NewTweetCard = ({ togglePopupVis }) => {
  ...
  return (
    <div className="new-tweet-card-container">
      <div className="new-tweet-card-container__header">
        <div className="new-tweet-card-container__exit-svg-container" onClick={togglePopupVis}>
      ...
      <div className="new-tweet-card-container__content-container">
        ...
        <div className="new-tweet-card-container__right-column-container">
          ...
          <div className="new-tweet-card-container__icon-button-container">
            <div className="new-tweet-card-container__icon-tray">
              <div className="new-tweet-card-container__media-icon">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
              ...
              <div className="new-tweet-card-container__gif-icon">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  class="r-o6sn0fr-4qtqp9r-yyyyoor-z80fyvr-dnmrzsr-bnwqimr-1plcruir-lrvibrr-19wmn03"
              ...
              <div className="new-tweet-card-container__poll-icon">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  class="r-o6sn0fr-4qtqp9r-yyyyoor-z80fyvr-dnmrzsr-bnwqimr-1plcruir-lrvibrr-19wmn03"
              ...
              <div className="new-tweet-card-container__emoji-icon">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  class="r-o6sn0fr-4qtqp9r-yyyyoor-z80fyvr-dnmrzsr-bnwqimr-1plcruir-lrvibrr-19wmn03"
              ...
              <div className="new-tweet-card-container__schedule-icon">
                <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  class="r-o6sn0fr-4qtqp9r-yyyyoor-z80fyvr-dnmrzsr-bnwqimr-1plcruir-lrvibrr-19wmn03"
            ...
            <div className="new-tweet-card-container__tweet-button-container">
              <div className="new-tweet-card-container__tweet-button">
                <span>
                  Tweet
                </span>
              </div>
