            ...
            <form onSubmit={(e) => postATweet(e, tweet)}>
              ...
              <div className="interactions">
                <div className="reactions">
                  <svg viewBox="0 0 24 24" aria-hidden="true" className="media">
                    <g>
                  ...
                  <svg viewBox="0 0 24 24" aria-hidden="true" className="gif">
                    <g>
                  ...
                  <svg viewBox="0 0 24 24" aria-hidden="true" className="poll">
                    <g>
                  ...
                  <svg viewBox="0 0 24 24" aria-hidden="true" className="emoji">
                    <g>
                  ...
                  <svg viewBox="0 0 24 24" aria-hidden="true" className="schedule">
                    <g>
