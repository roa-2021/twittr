    ...
    return (
        <div className="login-form--container">
            ...
            <form action="" className="login-form">
                ...
                <select name="" id="" className="month">
                    <option value="#">Month</option>
                </select>
                <select name="" id="" className="day">
