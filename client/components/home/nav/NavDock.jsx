...
const NavDock = () => {
        ...
        <div className='nav-content'>
          ...
          <div className='logo-container'>
            <h1>
              <a>
                <div>
                  <svg viewBox="0 0 24 24" aria-hidden="true" class=" r-1cvl2hr r-4qtqp9 r-yyyyoo r-16y2uox r-8kz0gk r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp">
                    <g>
  ...
  "
                  ...
                  <div className="home-button span-container">
                    <span>
                      Home
                    </span>
                  </div>
  ...
  "
                  ...
                  <div className="explore-button span-container">
                    <span>
                      Explore
                    </span>
                  </div>
  ...
  "
                  ...
                  <div className="notifications-button span-container">
                    <span>
                      Notifications
                    </span>
                  </div>
  ...
  "
                  ...
                  <div className="messages-button span-container">
                    <span>
                      Messages
                    </span>
                  </div>
              ...
              <a>
                <div className="link-button lists-button">
                  <div className="lists-button svg-container">
                    <svg viewBox="0 0 24 24" aria-hidden="true" class="r-1fmj7o5 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
                  ...
                  <div className="lists-button span-container">
                    <span>
                      Lists
                    </span>
                  </div>
  ...
  "
                  ...
                  <div className="profile-button span-container">
                    <span>
                      Profile
                    </span>
                  </div>
              ...
              <div>
                <div className="link-button more-button">
                  <div className="more-button svg-container">
                    <svg
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                      class="
  ...
  "
                  ...
                  <div className="more-button span-container">
                    <span>
                      More
                    </span>
                  </div>
